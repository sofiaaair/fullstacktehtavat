describe('Blog app', function(){
  ...
  describe('When logged in', function(){
    ...
    it('A blog can be created', function() {
      ...
      cy.get('.notification').contains('A new blog SARA PARIKKA by Sara Parikka added')
      cy.get('.blogTitles').contains('SARA PARIKKA')
    })

    it('A blog can be liked', function() {
      cy.addBlog({ title:'Kasvisannos', author:'Anita', url:'kasvisannos.fi' })
    ...
    it('A blog can be removed', function() {
      cy.addBlog({ title:'Kasvisannos', author:'Anita', url:'kasvisannos.fi' })
      cy.addBlog({ title:'SARA PARIKKA', author: 'Sara Parikka', url:'saraparikka.com' })
      cy.contains('show').click()
    ...
    it('Most liked blog is first on a list', function() {
      cy.addBlog({ title: 'Tuulanneli', author: 'Tuulanneli', url:'tuulanneli.fi' })
      cy.addBlog({ title:'Kasvisannos', author:'Anita', url:'kasvisannos.fi' })
      cy.addBlog({ title:'SARA PARIKKA', author: 'Sara Parikka', url:'saraparikka.com' })
